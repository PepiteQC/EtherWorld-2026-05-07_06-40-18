...
export const ALL_ZONES = [
  { zMin: -950, zMax: -780, name: 'Québec — Limite de ville'           },
  { zMin: -780, zMax: -570, name: 'Neuville — Bord du Fleuve'          },
  { zMin: -570, zMax: -360, name: 'Donnacona — Village'                },
  { zMin: -360, zMax: -170, name: 'Cap-Santé — Le Cap'                 },
  { zMin: -170, zMax:   20, name: 'Portneuf — Village'                 },
  { zMin:   20, zMax:  120, name: 'Flasheur — Route Guilbault'         },
  { zMin:  120, zMax:  290, name: 'Deschambault'                       },
  { zMin:  290, zMax:  450, name: 'Grondines'                          },
  { zMin:  450, zMax:  640, name: 'Sainte-Anne-de-la-Pérade'           },
  { zMin:  640, zMax:  810, name: 'Batiscan — Bord du Fleuve'          },
  { zMin:  810, zMax:  950, name: 'Trois-Rivières'                     },
  { zMin:  950, zMax: 1100, name: '🏙️ EtherWorld — Centre-Ville'       },
] as const
